...
case class ComplexLogicalTypes(var _map: Map[String, java.util.UUID], var _array: List[java.time.LocalDate], var _union: Int :+: java.time.Instant :+: CNil, var _option: Option[java.util.UUID], var _map_union: Map[String, Int :+: java.time.Instant :+: CNil], var _map_array: Map[String, List[java.time.LocalDate]], var _union_map: Int :+: Map[String, java.util.UUID] :+: CNil, var _union_array: Int :+: List[java.time.LocalDate] :+: CNil, var _array_map: List[Map[String, java.util.UUID]], var _array_union: List[Int :+: java.time.Instant :+: CNil], var _array_option: List[Option[java.util.UUID]]) extends org.apache.avro.specific.SpecificRecordBase {
