...
case class Reserved(var `abstract`: scala.Null, var `case`: Boolean, var `catch`: Int, var `class`: Long, var `def`: Float, var `do`: Double, var `else`: Array[Byte], var `extends`: String, var `false`: scala.Null, var `final`: Boolean, var `finally`: Int, var `for`: Long, var `forSome`: Float, var `if`: Double, var `implicit`: Array[Byte], var `import`: String, var `lazy`: scala.Null, var `macro`: Boolean, var `match`: Int, var `new`: Long, var `null`: Float, var `object`: Double, var `override`: Array[Byte], var `package`: String, var `private`: scala.Null, var `protected`: Boolean, var `return`: Int, var `sealed`: Long, var `super`: Float, var `this`: Double, var `throw`: Array[Byte], var `trait`: String, var `try`: scala.Null, var `true`: Boolean, var `type`: Int, var `val`: Long, var `var`: Float, var `while`: Double, var `with`: Array[Byte], var `yield`: String) extends org.apache.avro.specific.SpecificRecordBase {
  def this() = this(null, false, 0, 0, 0, 0, _root_.scala.Array.emptyByteArray, "", null, false, 0, 0, 0, 0, _root_.scala.Array.emptyByteArray, "", null, false, 0, 0, 0, 0, _root_.scala.Array.emptyByteArray, "", null, false, 0, 0, 0, 0, _root_.scala.Array.emptyByteArray, "", null, false, 0, 0, 0, 0, _root_.scala.Array.emptyByteArray, "")
  ...
  override def put(field$: Int, value: Any): Unit = {
    (field$: @switch) match {
      ...
      case 1 => this.`case` = value.asInstanceOf[Boolean]
      case 2 => this.`catch` = value.asInstanceOf[Int]
      case 3 => this.`class` = value.asInstanceOf[Long]
      ...
      case 9 => this.`final` = value.asInstanceOf[Boolean]
      case 10 => this.`finally` = value.asInstanceOf[Int]
      case 11 => this.`for` = value.asInstanceOf[Long]
      ...
      case 17 => this.`macro` = value.asInstanceOf[Boolean]
      case 18 => this.`match` = value.asInstanceOf[Int]
      case 19 => this.`new` = value.asInstanceOf[Long]
      ...
      case 25 => this.`protected` = value.asInstanceOf[Boolean]
      case 26 => this.`return` = value.asInstanceOf[Int]
      case 27 => this.`sealed` = value.asInstanceOf[Long]
      ...
      case 33 => this.`true` = value.asInstanceOf[Boolean]
      case 34 => this.`type` = value.asInstanceOf[Int]
      case 35 => this.`val` = value.asInstanceOf[Long]
