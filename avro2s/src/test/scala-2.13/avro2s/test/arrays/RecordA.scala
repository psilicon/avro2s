...
object RecordA {
  val SCHEMA$: org.apache.avro.Schema = new org.apache.avro.SchemaParser().parse("""{"type":"record","name":"RecordA","namespace":"avro2s.test.arrays","fields":[{"name":"_string","type":"string"}]}""").mainSchema()
}