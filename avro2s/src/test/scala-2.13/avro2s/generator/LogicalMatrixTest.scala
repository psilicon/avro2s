...
class LogicalMatrixTest extends AnyFunSuite with Matchers {
  ...
  LogicalMatrix(
    ...
    LogicalMatrixUnions(
    Coproduct[scala.Null :+: java.util.UUID :+: Int :+: CNil](java.util.UUID.fromString("f81d4fae-7dec-11d0-a765-00a0c91e6bf6")),
    Coproduct[scala.Null :+: java.time.LocalDate :+: String :+: CNil](java.time.LocalDate.ofEpochDay(19000)),
    Coproduct[scala.Null :+: java.time.LocalTime :+: String :+: CNil](java.time.LocalTime.of(23, 59, 59, 999000000)),
    Coproduct[scala.Null :+: java.time.LocalTime :+: String :+: CNil](java.time.LocalTime.of(23, 59, 59, 999999000)),
    Coproduct[scala.Null :+: java.time.Instant :+: String :+: CNil](java.time.Instant.ofEpochMilli(1700000000123L)),
    Coproduct[scala.Null :+: java.time.Instant :+: String :+: CNil](java.time.Instant.ofEpochSecond(1700000000L, 123456000)),
    Coproduct[scala.Null :+: java.time.Instant :+: String :+: CNil](java.time.Instant.ofEpochSecond(1700000000L, 123456789)),
    Coproduct[scala.Null :+: java.time.LocalDateTime :+: String :+: CNil](java.time.LocalDateTime.ofEpochSecond(1700000000L, 123000000, java.time.ZoneOffset.UTC)),
    Coproduct[scala.Null :+: java.time.LocalDateTime :+: String :+: CNil](java.time.LocalDateTime.ofEpochSecond(1700000000L, 123456000, java.time.ZoneOffset.UTC)),
    Coproduct[scala.Null :+: java.time.LocalDateTime :+: String :+: CNil](java.time.LocalDateTime.ofEpochSecond(1700000000L, 123456789, java.time.ZoneOffset.UTC)),
    Coproduct[scala.Null :+: scala.math.BigDecimal :+: String :+: CNil](scala.math.BigDecimal("12345.67")),
    Coproduct[scala.Null :+: scala.math.BigDecimal :+: String :+: CNil](scala.math.BigDecimal("1234567.8901")),
    Coproduct[scala.Null :+: java.math.BigDecimal :+: String :+: CNil](new java.math.BigDecimal("12345.6789")),
    Coproduct[scala.Null :+: org.apache.avro.util.TimePeriod :+: String :+: CNil](org.apache.avro.util.TimePeriod.of(1L, 2L, 3L))),
  ...
  LogicalMatrix(
    ...
    None),
    LogicalMatrixUnions(
    Coproduct[scala.Null :+: java.util.UUID :+: Int :+: CNil](7),
    Coproduct[scala.Null :+: java.time.LocalDate :+: String :+: CNil]("alt"),
    Coproduct[scala.Null :+: java.time.LocalTime :+: String :+: CNil]("alt"),
    Coproduct[scala.Null :+: java.time.LocalTime :+: String :+: CNil]("alt"),
    Coproduct[scala.Null :+: java.time.Instant :+: String :+: CNil]("alt"),
    Coproduct[scala.Null :+: java.time.Instant :+: String :+: CNil]("alt"),
    Coproduct[scala.Null :+: java.time.Instant :+: String :+: CNil]("alt"),
    Coproduct[scala.Null :+: java.time.LocalDateTime :+: String :+: CNil]("alt"),
    Coproduct[scala.Null :+: java.time.LocalDateTime :+: String :+: CNil]("alt"),
    Coproduct[scala.Null :+: java.time.LocalDateTime :+: String :+: CNil]("alt"),
    Coproduct[scala.Null :+: scala.math.BigDecimal :+: String :+: CNil]("alt"),
    Coproduct[scala.Null :+: scala.math.BigDecimal :+: String :+: CNil]("alt"),
    Coproduct[scala.Null :+: java.math.BigDecimal :+: String :+: CNil]("alt"),
    Coproduct[scala.Null :+: org.apache.avro.util.TimePeriod :+: String :+: CNil]("alt")),
    LogicalMatrixArraysOfMaps(
    List.empty,
    List.empty,
    List.empty,
  ...
  // Edge values driven into every nested position, mirroring the Scala 3 suite. The two nanos
  // types are held after the epoch here and only here: Scala 2 cannot emit a static MODEL$, so a
  // nested pre-epoch nanos value is converted by Avro's own conversion, whose toLong is wrong
  // before 1970 until the upstream fix ships. LogicalNanosModelTest pins that limitation head-on;
  // this fixture exists so everything else in the nested positions is still guarded.
  ...
  LogicalMatrix(
    ...
    LogicalMatrixOptions(
      ...
      Some(edgeDuration)),
    LogicalMatrixUnions(
      Coproduct[scala.Null :+: java.util.UUID :+: Int :+: CNil](edgeUuid),
      Coproduct[scala.Null :+: java.time.LocalDate :+: String :+: CNil](edgeDate),
      Coproduct[scala.Null :+: java.time.LocalTime :+: String :+: CNil](edgeTimeMillis),
      Coproduct[scala.Null :+: java.time.LocalTime :+: String :+: CNil](edgeTimeMicros),
      Coproduct[scala.Null :+: java.time.Instant :+: String :+: CNil](edgeTsMillis),
      Coproduct[scala.Null :+: java.time.Instant :+: String :+: CNil](edgeTsMicros),
      Coproduct[scala.Null :+: java.time.Instant :+: String :+: CNil](edgeTsNanos),
      Coproduct[scala.Null :+: java.time.LocalDateTime :+: String :+: CNil](edgeLtsMillis),
      Coproduct[scala.Null :+: java.time.LocalDateTime :+: String :+: CNil](edgeLtsMicros),
      Coproduct[scala.Null :+: java.time.LocalDateTime :+: String :+: CNil](edgeLtsNanos),
      Coproduct[scala.Null :+: scala.math.BigDecimal :+: String :+: CNil](edgeDecBytes),
      Coproduct[scala.Null :+: scala.math.BigDecimal :+: String :+: CNil](edgeDecFixed),
      Coproduct[scala.Null :+: java.math.BigDecimal :+: String :+: CNil](edgeBigDec),
      Coproduct[scala.Null :+: org.apache.avro.util.TimePeriod :+: String :+: CNil](edgeDuration)),
    LogicalMatrixArraysOfMaps(
      List(Map("k" -> edgeUuid)),
      List(Map("k" -> edgeDate)),
