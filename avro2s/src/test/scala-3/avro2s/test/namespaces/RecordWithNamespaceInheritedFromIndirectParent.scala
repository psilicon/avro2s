...
case class RecordWithNamespaceInheritedFromIndirectParent(var _string: String) extends org.apache.avro.specific.SpecificRecordBase {
  ...
  private def encode$0(value$: _root_.avro2s.test.namespaces.RecordWithNamespaceInheritedFromIndirectParent, out$: _root_.org.apache.avro.io.Encoder): Unit = {
    encode$1(value$.`_string`, out$)
  }

  private def decode$0(in$: _root_.org.apache.avro.io.ResolvingDecoder, reuse$: _root_.avro2s.test.namespaces.RecordWithNamespaceInheritedFromIndirectParent): _root_.avro2s.test.namespaces.RecordWithNamespaceInheritedFromIndirectParent = {
  ...
  private def decodeRecord$0(value$: _root_.avro2s.test.namespaces.RecordWithNamespaceInheritedFromIndirectParent, in$: _root_.org.apache.avro.io.ResolvingDecoder): Unit = {
...
object RecordWithNamespaceInheritedFromIndirectParent {
  val SCHEMA$: org.apache.avro.Schema = new _root_.org.apache.avro.Schema.Parser().parse("""{"type":"record","name":"RecordWithNamespaceInheritedFromIndirectParent","namespace":"avro2s.test.namespaces","fields":[{"name":"_string","type":"string"}]}""")
}