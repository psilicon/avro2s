...
case class RecordWithNamespaceInheritedFromIndirectNonTopLevelParent(var _string: String) extends org.apache.avro.specific.SpecificRecordBase {
  ...
  private def encode$0(value$: _root_.avro2s.test.namespaces.explicit.RecordWithNamespaceInheritedFromIndirectNonTopLevelParent, out$: _root_.org.apache.avro.io.Encoder): Unit = {
    encode$1(value$.`_string`, out$)
  }

  private def decode$0(in$: _root_.org.apache.avro.io.ResolvingDecoder, reuse$: _root_.avro2s.test.namespaces.explicit.RecordWithNamespaceInheritedFromIndirectNonTopLevelParent): _root_.avro2s.test.namespaces.explicit.RecordWithNamespaceInheritedFromIndirectNonTopLevelParent = {
  ...
  private def decodeRecord$0(value$: _root_.avro2s.test.namespaces.explicit.RecordWithNamespaceInheritedFromIndirectNonTopLevelParent, in$: _root_.org.apache.avro.io.ResolvingDecoder): Unit = {
...
object RecordWithNamespaceInheritedFromIndirectNonTopLevelParent {
  val SCHEMA$: org.apache.avro.Schema = new _root_.org.apache.avro.Schema.Parser().parse("""{"type":"record","name":"RecordWithNamespaceInheritedFromIndirectNonTopLevelParent","namespace":"avro2s.test.namespaces.explicit","fields":[{"name":"_string","type":"string"}]}""")
}