...
case class RecordWithNamespaceInheritedViaMap(var _string: String) extends org.apache.avro.specific.SpecificRecordBase {
  ...
  private def encode$0(value$: _root_.avro2s.test.namespaces.explicit.RecordWithNamespaceInheritedViaMap, out$: _root_.org.apache.avro.io.Encoder): Unit = {
    encode$1(value$.`_string`, out$)
  }

  private def decode$0(in$: _root_.org.apache.avro.io.ResolvingDecoder, reuse$: _root_.avro2s.test.namespaces.explicit.RecordWithNamespaceInheritedViaMap): _root_.avro2s.test.namespaces.explicit.RecordWithNamespaceInheritedViaMap = {
  ...
  private def decodeRecord$0(value$: _root_.avro2s.test.namespaces.explicit.RecordWithNamespaceInheritedViaMap, in$: _root_.org.apache.avro.io.ResolvingDecoder): Unit = {
...
object RecordWithNamespaceInheritedViaMap {
  val SCHEMA$: org.apache.avro.Schema = new _root_.org.apache.avro.Schema.Parser().parse("""{"type":"record","name":"RecordWithNamespaceInheritedViaMap","namespace":"avro2s.test.namespaces.explicit","fields":[{"name":"_string","type":"string"}]}""")
}