...
object DecimalFixed {
  val SCHEMA$ = new _root_.org.apache.avro.Schema.Parser().parse("""{"type":"fixed","name":"DecimalFixed","namespace":"avro2s.test.logical","size":2,"logicalType":"decimal","precision":4,"scale":2}""")
