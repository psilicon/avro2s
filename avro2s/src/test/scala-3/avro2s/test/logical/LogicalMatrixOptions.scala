  ...
  override def put(field$: Int, value: Any): Unit = {
    (field$: @switch) match {
      ...
      case 2 => this._time_millis = {
        value match {
          case null => None
          case x: java.time.LocalTime => Option(x.asInstanceOf[java.time.LocalTime])
          case x: Int => Option({java.time.LocalTime.ofNanoOfDay(x * 1000000L)}.asInstanceOf[java.time.LocalTime])
          case _ => throw new org.apache.avro.AvroRuntimeException("Unexpected type: " + value.getClass.getName)
        }
      }
      case 3 => this._time_micros = {
        value match {
          case null => None
          case x: java.time.LocalTime => Option(x.asInstanceOf[java.time.LocalTime])
          case x: Long => Option({java.time.LocalTime.ofNanoOfDay(x * 1000L)}.asInstanceOf[java.time.LocalTime])
          case _ => throw new org.apache.avro.AvroRuntimeException("Unexpected type: " + value.getClass.getName)
        }
      }
      ...
      case 5 => this._timestamp_micros = {
        value match {
          case null => None
          case x: java.time.Instant => Option(x.asInstanceOf[java.time.Instant])
          case x: Long => Option({java.time.Instant.ofEpochSecond(x / 1000000L, (x % 1000000L) * 1000L)}.asInstanceOf[java.time.Instant])
          case _ => throw new org.apache.avro.AvroRuntimeException("Unexpected type: " + value.getClass.getName)
        }
      }
      case 6 => this._timestamp_nanos = {
        value match {
          case null => None
          case x: java.time.Instant => Option(x.asInstanceOf[java.time.Instant])
          case x: Long => Option({java.time.Instant.ofEpochSecond(java.lang.Math.floorDiv(x, 1000000000L), java.lang.Math.floorMod(x, 1000000000L))}.asInstanceOf[java.time.Instant])
          case _ => throw new org.apache.avro.AvroRuntimeException("Unexpected type: " + value.getClass.getName)
        }
      }
      case 7 => this._local_timestamp_millis = {
        value match {
          case null => None
          case x: java.time.LocalDateTime => Option(x.asInstanceOf[java.time.LocalDateTime])
          case x: Long => Option({java.time.LocalDateTime.ofInstant(java.time.Instant.ofEpochMilli(x), java.time.ZoneId.of("UTC"))}.asInstanceOf[java.time.LocalDateTime])
          case _ => throw new org.apache.avro.AvroRuntimeException("Unexpected type: " + value.getClass.getName)
        }
      }
      case 8 => this._local_timestamp_micros = {
        value match {
          case null => None
          case x: java.time.LocalDateTime => Option(x.asInstanceOf[java.time.LocalDateTime])
          case x: Long => Option({java.time.LocalDateTime.ofInstant(java.time.Instant.ofEpochSecond(x / 1000000L, (x % 1000000L) * 1000L), java.time.ZoneId.of("UTC"))}.asInstanceOf[java.time.LocalDateTime])
          case _ => throw new org.apache.avro.AvroRuntimeException("Unexpected type: " + value.getClass.getName)
        }
      }
      case 9 => this._local_timestamp_nanos = {
        value match {
          case null => None
          case x: java.time.LocalDateTime => Option(x.asInstanceOf[java.time.LocalDateTime])
          case x: Long => Option({java.time.LocalDateTime.ofEpochSecond(java.lang.Math.floorDiv(x, 1000000000L), java.lang.Math.floorMod(x, 1000000000L).toInt, java.time.ZoneOffset.UTC)}.asInstanceOf[java.time.LocalDateTime])
          case _ => throw new org.apache.avro.AvroRuntimeException("Unexpected type: " + value.getClass.getName)
        }
      }
      ...
      case 12 => this._big_decimal = {
        value match {
          case null => None
          case x: java.math.BigDecimal => Option(x.asInstanceOf[java.math.BigDecimal])
