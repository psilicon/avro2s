...
case class RecordB(var _string: String) extends org.apache.avro.specific.SpecificRecordBase {
  ...
  private def encode$0(value$: _root_.avro2s.test.arrays.RecordB, out$: _root_.org.apache.avro.io.Encoder): Unit = {
    encode$1(value$.`_string`, out$)
  }

  private def decode$0(in$: _root_.org.apache.avro.io.ResolvingDecoder, reuse$: _root_.avro2s.test.arrays.RecordB): _root_.avro2s.test.arrays.RecordB = {
    val result$ = if (reuse$ == null) new _root_.avro2s.test.arrays.RecordB() else reuse$
    decodeRecord$0(result$, in$)
    result$
  }

  private def decodeRecord$0(value$: _root_.avro2s.test.arrays.RecordB, in$: _root_.org.apache.avro.io.ResolvingDecoder): Unit = {
...
object RecordB {
  val SCHEMA$: org.apache.avro.Schema = new _root_.org.apache.avro.Schema.Parser().parse("""{"type":"record","name":"RecordB","namespace":"avro2s.test.arrays","fields":[{"name":"_string","type":"string"}]}""")
}