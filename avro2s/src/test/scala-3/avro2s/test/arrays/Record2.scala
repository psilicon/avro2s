...
case class Record2(var _string: String, var _int: Int) extends org.apache.avro.specific.SpecificRecordBase {
  ...
  private def encode$0(value$: _root_.avro2s.test.arrays.Record2, out$: _root_.org.apache.avro.io.Encoder): Unit = {
    encode$1(value$.`_string`, out$)
    encode$2(value$.`_int`, out$)
  }

  private def decode$0(in$: _root_.org.apache.avro.io.ResolvingDecoder, reuse$: _root_.avro2s.test.arrays.Record2): _root_.avro2s.test.arrays.Record2 = {
    val result$ = if (reuse$ == null) new _root_.avro2s.test.arrays.Record2() else reuse$
    decodeRecord$0(result$, in$)
    result$
  }

  private def decodeRecord$0(value$: _root_.avro2s.test.arrays.Record2, in$: _root_.org.apache.avro.io.ResolvingDecoder): Unit = {
...
object Record2 {
  val SCHEMA$: org.apache.avro.Schema = new _root_.org.apache.avro.Schema.Parser().parse("""{"type":"record","name":"Record2","namespace":"avro2s.test.arrays","fields":[{"name":"_string","type":"string"},{"name":"_int","type":"int"}]}""")
}