...
case class Record1(var field1: String) extends org.apache.avro.specific.SpecificRecordBase {
  ...
  private def encode$0(value$: _root_.avro2s.test.unions.Record1, out$: _root_.org.apache.avro.io.Encoder): Unit = {
    encode$1(value$.`field1`, out$)
  }

  private def decode$0(in$: _root_.org.apache.avro.io.ResolvingDecoder, reuse$: _root_.avro2s.test.unions.Record1): _root_.avro2s.test.unions.Record1 = {
    val result$ = if (reuse$ == null) new _root_.avro2s.test.unions.Record1() else reuse$
    decodeRecord$0(result$, in$)
    result$
  }

  private def decodeRecord$0(value$: _root_.avro2s.test.unions.Record1, in$: _root_.org.apache.avro.io.ResolvingDecoder): Unit = {
...
object Record1 {
  val SCHEMA$: org.apache.avro.Schema = new _root_.org.apache.avro.Schema.Parser().parse("""{"type":"record","name":"Record1","namespace":"avro2s.test.unions","fields":[{"name":"field1","type":"string"}]}""")
}